  ...
  if (isMobile) {
    return (
      <main className="flex-1 flex flex-col justify-stretch relative bg-black select-none text-white p-6 min-h-dvh h-dvh overflow-hidden">
        ...
        {/* Apenas 2 botões circulares alinhados verticalmente no centro */}
        <div className="flex-1 flex flex-col items-center justify-center gap-12 py-4 h-full">
          {/* Botão Gasto (Saída) */}
          <button
            onClick={() => openInsertModal("expense")}
            className="w-32 h-32 rounded-full flex flex-col items-center justify-center border-2 border-red-500/30 bg-red-950/10 text-red-400 active:scale-90 transition-all shadow-xl shadow-red-500/10 hover:border-red-500/50"
          >
          ...
          <button
            ...
            className="w-32 h-32 rounded-full flex flex-col items-center justify-center border-2 border-blue-500/30 bg-blue-950/10 text-blue-400 active:scale-90 transition-all shadow-xl shadow-blue-500/10 hover:border-blue-500/50"
          >
            <span className="text-xs font-black uppercase tracking-[0.2em]">
              Entrada
            </span>
